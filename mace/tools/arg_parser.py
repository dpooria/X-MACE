...
def build_default_arg_parser() -> argparse.ArgumentParser:
    ...
    parser.add_argument(
        "--num_permutational_invariant", help="Number of permutationally invariant polynomials", type=int, default=16
    )
    parser.add_argument(
        "--radial_type",
    ...
    parser.add_argument(
        "--lr", help="Learning rate of optimizer", type=float, default=0.001
    )
    parser.add_argument(
        "--swa_lr",
        "--stage_two_lr",
